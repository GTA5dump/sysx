...
namespace PLAYER
{
	...
	static void KE_AE_PE(Player player, Hash modelHash) { invoke<Void>(0x00A1CADD00108836, player, modelHash); }
	static void KEJ_AJD(Player player, Hash modelHash) { invoke<Void>(0x00A1CADD00108836, player, modelHash); }
	...
	static void DDD_E(Player player, BOOL toggle) { invoke<Void>(0x5E6CC07646BBEAB8, player, toggle); }
...
namespace ENTITY
{
	...
	static void K_D_E(Entity entity, BOOL toggle) { invoke<Void>(0x3882114BDE571AD4, entity, toggle); }
	...
	static void K_K_J_K(Entity entity, BOOL bulletProof, BOOL fireProof, BOOL explosionProof, BOOL collisionProof, BOOL meleeProof, BOOL p6, BOOL p7, BOOL drownProof) { invoke<Void>(0xFAEE099C6F890BB8, entity, bulletProof, fireProof, explosionProof, collisionProof, meleeProof, p6, p7, drownProof); }
	...
	static void E_V_P(Entity entity, BOOL toggle, BOOL unk) { invoke<Void>(0xEA1C610A04DB6BBB, entity, toggle, unk); }
...
namespace VEHICLE
{
	...
	static Vehicle C_V(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); }
	...
	static void K_K_K_J_H(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x3E8C8727991A8A0B, vehicle, toggle); }
	...
	static void KKK_U_J(Vehicle vehicle, BOOL state) { invoke<Void>(0x4C7028F78FFD3681, vehicle, state); }
	...
	static void J_KK_H(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x59BF8C3D52C92F66, vehicle, toggle); }
	...
	static void KK_K_J_U(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x983765856F2564F9, vehicle, toggle); }
...
namespace OBJECT
{
	...
	static Object HAE_AE_E(Object modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { return invoke<Object>(0x509D5878EB39E842, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic); }
	...
	static Pickup CREAT_A(Hash pickupHash, float posX, float posY, float posZ, int flag, int value, Hash modelHash, BOOL returnHandle, BOOL p8) { return invoke<Pickup>(0x673966A0C0FD7171, pickupHash, posX, posY, posZ, flag, value, modelHash, returnHandle, p8); }
...
namespace GAMEPLAY
{
	...
	static void J_EEEE_DDD_L_E_L(float x1, float y1, float z1, float x2, float y2, float z2, int damage, BOOL p7, Hash weaponHash, Ped ownerPed, BOOL isAudible, BOOL isInvisible, float speed) { invoke<Void>(0x867654CBC7606F2C, x1, y1, z1, x2, y2, z2, damage, p7, weaponHash, ownerPed, isAudible, isInvisible, speed); }
	...
	static void S_S_J_T_F(Player player) { invoke<Void>(0x57FFF03E423A4C0B, player); }
...
namespace CAM
{
	...
	static Vector3 J_E_E_EEE(int rotationOrder) { return invoke<Vector3>(0x837765A25378F0BB, rotationOrder); }
	...
	static Vector3 _E_LLLL_A() { return invoke<Vector3>(0xA200EB1EE790F448); }
...
namespace WEAPON
{
	...
	static BOOL J_EEE_DDDD(Ped ped, Hash* weaponHash, BOOL unused) { return invoke<BOOL>(0x3A87E44BB9A01D54, ped, weaponHash, unused); }
	...
	static BOOL G_P_L(Ped ped, Vector3* coords) { return invoke<BOOL>(0x6C4D0409BA1A2BC2, ped, coords); }
...
namespace CONTROLS
{
	...
	static BOOL K_E_E_E_E(int inputGroup, int contorl) { return invoke<BOOL>(0xF3A21BCD95725A4A, inputGroup, contorl); }
...
namespace FIRE
{
	...
	static void A_A_E_E(float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake) { invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake); }
	static void A_E(float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake) { invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake); }
	...
	static void OAW_AW(Ped ped, float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake) { invoke<Void>(0x172AA1B624FA1013, ped, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake); }
...
namespace DECORATOR
{
	...
	static Hash* DECOR_GET_INT(Entity entity, char* propertyName) { return invoke<Hash*>(0xA06C969B02A97298, entity, propertyName); } // 0xA06C969B02A97298 0xDDDE59B5
...
namespace UNK3
{
	...
	static BOOL _S_AE_E(Any p0) { return invoke<BOOL>(0x39BE7CEA8D9CC8E6, p0); }
	...
	static BOOL _K_AE_A(int* transactionID, Hash p1, Hash transactionHash, int amount, Hash p4, int mode) { return invoke<BOOL>(0x3C5FD37B5499582E, transactionID, p1, transactionHash, amount, p4, mode); }
